...
public sealed class FileContentVersionManager : ResourceManager
{
  ...
  public async Task<Resource[]> List(ResourceService.Transaction transaction, FileContentManager.Resource fileContent)
  {
    return await Select(transaction, new WhereClause.CompareColumn(COLUMN_FILE_CONTENT_ID, "=", fileContent.Id));
  }
